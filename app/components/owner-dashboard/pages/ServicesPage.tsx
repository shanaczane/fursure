                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="h-36 flex items-center justify-center relative" style={{ background: colors.bg }}>
                        ...
                        <span
                          className="absolute top-3 right-3 text-xs font-700 px-3 py-1 rounded-full bg-white capitalize"
                      ...
                      <div className="p-5">
                        ...
                        >
                          ...
                          <span
                            className="text-xs font-700 px-3 py-1.5 rounded-xl text-white"
