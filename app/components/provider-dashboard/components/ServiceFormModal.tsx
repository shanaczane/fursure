...
import type { ProviderService, ProviderServiceCategory } from "../..provider-dashboard/../types";
import { PROVIDER_SERVICE_CATEGORIES } from "../..provider-dashboard/../types";
...
const CATEGORY_EMOJIS: Record<ProviderServiceCategory, string> = {
  grooming: "✂️",
  veterinary: "🏥",
  training: "🎓",
  boarding: "🏠",
            ...
            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg border border-gray-200">
              <div>
                ...
                <p className="text-xs text-gray-500">
                  {form.isActive ? "Visible to pet owners for booking" : "Hidden from pet owners"}
                </p>
              </div>
              <button
                type="button"
